...
func Test_prepareFlagsForTxCreateValidator(t *testing.T) {
	...
	valPubKey, _ := sdk.GetConsPubKeyBech32("bacsvalconspub1zcjduepq7jsrkl9fgqk0wj3ahmfr8pgxj6vakj2wzn656s8pehh0zhv2w5as5gd80a")
	...
	tests := []testcase{
		...
		{"Optional parameters fed", args{ctx.Config, "X", "0.0.0.0", "chainId", valPubKey, "bacs.network", "details", "identity"}},
	}
