...
import (
	...
	"github.com/bitcv-chain/bitcv-chain/server/mock"
...
func TestInitCmd(t *testing.T) {
	...
	require.NoError(t, cmd.RunE(nil, []string{"bacnode-test"}))
}
...
func TestStartStandAlone(t *testing.T) {
	...
	require.NoError(t, initCmd.RunE(nil, []string{"bacnode-test"}))
