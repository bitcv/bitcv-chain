...
Query details for a proposal. You can find the proposal-id by running baccli query gov proposals:

$ baccli query gov proposal 1
`),
...
$ baccli query gov proposals --depositor bac1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ baccli query gov proposals --voter bac1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ baccli query gov proposals --status (DepositPeriod|VotingPeriod|Passed|Rejected)
`),
		RunE: func(cmd *cobra.Command, args []string) error {
...
Example:
$ baccli query gov vote 1 bac1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
Example:
$ baccli query gov deposit 1 bac1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
func GetCmdQueryDeposits(queryRoute string, cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		...
		Long: strings.TrimSpace(`
Query details for all deposits on a proposal. You can find the proposal-id by running baccli query gov proposals:

$ baccli query gov deposits 1
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
func GetCmdQueryTally(queryRoute string, cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		...
		Long: strings.TrimSpace(`
Query tally of votes on a proposal. You can find the proposal-id by running baccli query gov proposals:

$ baccli query gov tally 1
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ baccli query gov param voting
$ baccli query gov param tallying
$ baccli query gov param deposit
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
