...
const (
	...
	DefaultPeriod time.Duration = 86400 * 14 * time.Second // 14 days
)
...
func DefaultGenesisState() GenesisState {
	minDepositTokens := sdk.TokensFromTendermintPower(1000) //最小1000bcv
	return GenesisState{
		StartingProposalID: 1,
		DepositParams: DepositParams{
			MinDeposit:       sdk.Coins{sdk.NewCoin(sdk.DefaultBCVDemon, minDepositTokens)},
