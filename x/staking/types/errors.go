...
const (
	...
	CodeNotEnoughEnergy	  CodeType = sdk.CodeNotEnoughEnergy
	CodeCreateValidatorAmountInvalid	  CodeType = sdk.CodeCreateValidatorAmountInvalid
...
func ErrValidatorOnlyBondStatusSupport(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidValidator, "only validator in bond status  support this method")
}
...
func ErrCreateValidatorAmountInvalid	(codespace sdk.CodespaceType,errMsg string) sdk.Error {
	return sdk.NewError(codespace, CodeCreateValidatorAmountInvalid,errMsg)
}
func ErrAmountUnbondExceed(codespace sdk.CodespaceType,canUnbond sdk.Int,msgAmount sdk.Int ,shareAmount sdk.Int) sdk.Error {
	return sdk.NewError(codespace, CodeNotEnoughEnergy, fmt.Sprintf("can only unbond  %v ubcvstake,msgAmount is %v;shareAmount %v",canUnbond,msgAmount,shareAmount))
}
...
func ErrNilAccountAddr(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidInput, "account address is nil")
}
func ErrNotEnoughEnergy(codespace sdk.CodespaceType, costEnergy sdk.Int) sdk.Error {
	return sdk.NewError(codespace, CodeNotEnoughEnergy, fmt.Sprintf("need energy %v,but not enough",costEnergy))
}
...
//非正的amount
func ErrAmountNegative(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidDelegation, "amount must be > 0")
}
...
func ErrUnbondNotAllowed(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidValidator, "validator can unbond the ubcv, other cannt withdraw ubcv")
}