...
$ baccli query staking validator bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
...
$ baccli query staking validators
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ baccli query staking unbonding-delegations-from bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ baccli query staking redelegations-from bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ baccli query staking delegation bac1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
...
$ baccli query staking delegations bac1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ baccli query staking delegations-to bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ baccli query staking unbonding-delegation bac1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ baccli query staking unbonding-delegation bac1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
...
$ baccli query staking redelegation bac1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p bacvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`),
...
$ baccli query staking redelegation bac1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			cliCtx := context.NewCLIContext().WithCodec(cdc)
