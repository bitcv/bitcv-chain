...
func (k *Keeper) SetDistrKeeper( dk types.DistributionKeeper) *Keeper{
	k.distrKeeper = dk
	return k
}
...
////for test
//func (k *Keeper) GetValidatorsByPowerIndexKey(v types.Validator) []byte{
//	return GetValidatorsByPowerIndexKey(v)
//}