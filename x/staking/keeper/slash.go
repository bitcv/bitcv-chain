...
import (
	...
	types "github.com/bitcv-chain/bitcv-chain/x/staking/types"
)
...
func (k Keeper) Slash(ctx sdk.Context, consAddr sdk.ConsAddress, infractionHeight int64, power int64, slashFactor sdk.Dec) {
	...
	// ref https://github.com/bitcv-chain/bitcv-chain/issues/1348
...
func (k Keeper) slashUnbondingDelegation(ctx sdk.Context, unbondingDelegation types.UnbondingDelegation,
	...
	for i, entry := range unbondingDelegation.Entries {
		...
		// Ref https://github.com/bitcv-chain/bitcv-chain/pull/1278#discussion_r198657760
...
func (k Keeper) slashRedelegation(ctx sdk.Context, validator types.Validator, redelegation types.Redelegation,
	...
	for _, entry := range redelegation.Entries {
		...
		tokensToBurn,_,err := k.unbond(ctx, redelegation.DelegatorAddress, redelegation.ValidatorDstAddress, sharesToUnbond)
		if err != nil {
