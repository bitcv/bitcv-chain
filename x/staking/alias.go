...
import (
	...
	"github.com/bitcv-chain/bitcv-chain/x/staking/querier"
...
var (
	...
	NewMsgExchangeBcvstakeToBcv  = types.NewMsgExchangeBcvstakeToBcv
	NewMsgBurnBcvToEnergy  = types.NewMsgBurnBcvToEnergy
	NewMsgBurnBcvToBcvstake	 = types.NewMsgBurnBcvToBcvstake
...
const (
	...
	QueryDelegationsAll	               = querier.QueryDelegationsAll
)
...
var (
	...
	ErrValidatorOnlyBondStatusSupport = types.ErrValidatorOnlyBondStatusSupport
	...
	ErrNilAccountAddr			 = types.ErrNilAccountAddr
	ErrAmountNegative		     = types.ErrAmountNegative
	...
	ErrAmountUnbondExceed                = types.ErrAmountUnbondExceed
	ErrCreateValidatorAmountInvalid	 = types.ErrCreateValidatorAmountInvalid
)
