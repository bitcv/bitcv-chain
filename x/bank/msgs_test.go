...
func TestMsgSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"bacchain/MsgSend","value":{"amount":[{"amount":"10","denom":"atom"}],"from_address":"bac1d9h8qat5ulv9hn","to_address":"bac1da6hgur4wsmqz8jy"}}`
...
// go test ../x/bank  -run TestCheckMsgIssueToken
func TestCheckMsgIssueToken(t *testing.T) {
	cases := []struct {
		msg MsgIssueToken
		err sdk.Error
	}{
		{NewMsgIssueToken(sdk.AccAddress([]byte("input")),"abc",sdk.NewInt(123),sdk.Coin{Amount:sdk.NewInt(1000000000),Denom:sdk.DefaultBCVDemon},2,"www.bitcv.com","test"),nil},
		{NewMsgIssueToken(sdk.AccAddress([]byte("input")),"testabc",sdk.NewInt(0),sdk.Coin{Amount:sdk.NewInt(1000000000),Denom:sdk.DefaultBCVDemon},2,"www.bitcv.com","test"),ErrIssueTokenSupplyNumErr(DefaultCodespace)},
		{NewMsgIssueToken(sdk.AccAddress([]byte("input")),"testabc",sdk.NewInt(10000),sdk.Coin{Amount:sdk.NewInt(1000000000),Denom:sdk.DefaultBCVDemon},2,"www.bitcv.com","test"),nil},
		{NewMsgIssueToken(sdk.AccAddress([]byte("input")),"testabc",sdk.NewInt(10000),sdk.Coin{Amount:sdk.NewInt(1000000000),Denom:sdk.DefaultBCVDemon},20,"www.bitcv.com","test"),ErrIssueTokenPrecisionErr(DefaultCodespace)},
		{NewMsgIssueToken(sdk.AccAddress([]byte("input")),"abc",sdk.NewInt(10000),sdk.Coin{Amount:sdk.NewInt(1000000000),Denom:sdk.DefaultBCVDemon},7,"www.bitcv.comwww.bitcv.comwww.bitcv.comwww.bitcv.comwww.bitcv.comwww.bitcv.comwww.bitcv.comwww.bitcv.comwww.bitcv.comwww.bitcv.comwww.b","test"),ErrIssueTokenWebsiteLenErr(DefaultCodespace)},
	}

	for _,tc := range cases{
		err := CheckMsgIssueToken(tc.msg)
