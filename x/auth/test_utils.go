...
func setupTestInput() testInput {
	...
	//init bac manage pool
	fck.SetBacManagePool(ctx,InitialBacManagePool())
...
func newStdFee() StdFee {
	return NewStdFee(100000000,
		sdk.NewCoins(sdk.NewInt64Coin("nbac",1 )),
	)
}
...
func newCoins() sdk.Coins {
	return sdk.Coins{
		sdk.NewInt64Coin("nbac", 200000000),
	}
}
