...
func TestStdSignBytes(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("{\"account_number\":\"3\",\"chain_id\":\"1234\",\"fee\":{\"amount\":[{\"amount\":\"1\",\"denom\":\"nbac\"}],\"gas\":\"100000000\"},\"memo\":\"memo\",\"msgs\":[[\"%s\"]],\"sequence\":\"6\"}", addr),
		},
	}
...
func TestDefaultTxEncoder(t *testing.T) {
	...
	RegisterCodec(cdc)
	cdc.RegisterConcrete(sdk.TestMsg{}, "bacchain/Test", nil)
