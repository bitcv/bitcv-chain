...
func TestAnteHandlerFees(t *testing.T) {
	...
	acc1.SetCoins(sdk.NewCoins(sdk.NewInt64Coin("nbac", 200000000)))
	input.ak.SetAccount(ctx, acc1)
	checkValidTx(t, anteHandler, ctx, tx, false)
}
...
func TestEnsureSufficientMempoolFees(t *testing.T) {
	...
	testCases := []struct {
		...
		{NewStdFee(200000, sdk.NewCoins(sdk.NewInt64Coin("stake", 2))), false},
		{NewStdFee(200000, sdk.NewCoins(sdk.NewInt64Coin("photino", 10))), false},
		{
			NewStdFee(
				200000,
				sdk.NewCoins(
