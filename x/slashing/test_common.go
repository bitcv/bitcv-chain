...
func createTestInput(t *testing.T, defaults Params) (sdk.Context, bank.Keeper, staking.Keeper, params.Subspace, Keeper) {
	...
	ck.AddCoins(ctx,sdk.AccAddrBcvstakePool,sdk.Coins{{sdk.CHAIN_COIN_NAME_BCVSTAKE,sdk.GetChainParamBcvStakeAmount()}})
...
func NewTestMsgCreateValidator(address sdk.ValAddress, pubKey crypto.PubKey, amt sdk.Int) staking.MsgCreateValidator {
	...
	return staking.NewMsgCreateValidator(
		address, pubKey, sdk.NewCoin(sdk.DefaultBCVDemon, amt),
