...
*
 */
func (k Keeper) WithdrawDelegationRewards(ctx sdk.Context, delAddr sdk.AccAddress, valAddr sdk.ValAddress) (sdk.Coins, sdk.Coins, sdk.Error) {
	val := k.stakingKeeper.Validator(ctx, valAddr)
	if val == nil {
		return nil, sdk.Coins{}, types.ErrNoValidatorDistInfo(k.codespace)
	}
	...
	// withdraw rewards
	rewards,costEnergyCoins, err := k.withdrawDelegationRewards(ctx, val, del)
	if err != nil {
	...
	return rewards, costEnergyCoins,nil
}
