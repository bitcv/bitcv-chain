...
$ baccli tx distr withdraw-rewards bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey
$ baccli tx distr withdraw-rewards bacvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey --commission
`),
...
$ baccli tx distr withdraw-all-rewards --from mykey
`),
		Args: cobra.NoArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
...
$ baccli tx set-withdraw-addr bac1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p --from mykey
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
