...
func ErrWithdrawEnergyNotEnough(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeNoDistributionInfo, "energy not enough, cannt withdraw the reward")
}
