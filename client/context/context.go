...
import (
	...
	cryptokeys "github.com/bitcv-chain/bitcv-chain/crypto/keys"
...
func createVerifier() tmlite.Verifier {
	...
	verifier, err := tmliteProxy.NewVerifier(
		chainID, filepath.Join(home, ".baclite"),
...
// an address or key name. If genOnly is true, only a valid Bech32 bac
// address is returned.
