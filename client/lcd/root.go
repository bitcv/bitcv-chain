...
import (
	...
	keybase "github.com/bitcv-chain/bitcv-chain/crypto/keys"
...
func (rs *RestServer) Start(listenAddr string, maxOpen int) (err error) {
	...
	rs.log.Info(
		fmt.Sprintf(
			"Starting Bac Lite REST service (chain-id: %q)...",
...
// ServeCommand will start a Bac Lite REST service as a blocking process. It
