...
import (
	...
	"github.com/bitcv-chain/bitcv-chain/crypto/keys/mintkey"
	...
	dclcommon "github.com/bitcv-chain/bitcv-chain/x/distribution/client/common"
...
func TestValidators(t *testing.T) {
	...
	require.Contains(t, resultVals.Validators[0].Address.String(), "bacsvalcons")
	require.Contains(t, resultVals.Validators[0].PubKey, "bacsvalconspub")
...
func TestPoolParamsQuery(t *testing.T) {
	...
	initialPool.BondedTokens = initialPool.BondedTokens.Add(tokens)           // Delegate tx on BacAppGenState
	initialPool.NotBondedTokens = initialPool.NotBondedTokens.Add(freeTokens) // freeTokensPerAcc = 50 on BacAppGenState
