...
import (
	...
	clientkeys "github.com/bitcv-chain/bitcv-chain/client/keys"
	...
	clienttx "github.com/bitcv-chain/bitcv-chain/client/tx"
	gapp "github.com/bitcv-chain/bitcv-chain/app"
	"github.com/bitcv-chain/bitcv-chain/codec"
	crkeys "github.com/bitcv-chain/bitcv-chain/crypto/keys"
	...
	authrest "github.com/bitcv-chain/bitcv-chain/x/auth/client/rest"
	txbuilder "github.com/bitcv-chain/bitcv-chain/x/auth/client/txbuilder"
	bankrest "github.com/bitcv-chain/bitcv-chain/x/bank/client/rest"
	distr "github.com/bitcv-chain/bitcv-chain/x/distribution"
	distrrest "github.com/bitcv-chain/bitcv-chain/x/distribution/client/rest"
	"github.com/bitcv-chain/bitcv-chain/x/gov"
	govrest "github.com/bitcv-chain/bitcv-chain/x/gov/client/rest"
	gcutils "github.com/bitcv-chain/bitcv-chain/x/gov/client/utils"
	mintrest "github.com/bitcv-chain/bitcv-chain/x/mint/client/rest"
	"github.com/bitcv-chain/bitcv-chain/x/slashing"
	slashingrest "github.com/bitcv-chain/bitcv-chain/x/slashing/client/rest"
	"github.com/bitcv-chain/bitcv-chain/x/staking"
	stakingrest "github.com/bitcv-chain/bitcv-chain/x/staking/client/rest"
...
func InitializeTestLCD(t *testing.T, nValidators int, initAddrs []sdk.AccAddress, minting bool) (
	...
	db := dbm.NewMemDB()
	app := gapp.NewBacApp(logger, db, nil, true, 0)
	cdc = gapp.MakeCodec()
	...
	require.NoError(t, err)
	genesisState, err := gapp.BacAppGenState(cdc, *genDoc, genTxs)
	require.NoError(t, err)
...
// NOTE: If making updates here also update cmd/bac/cmd/baccli/main.go
