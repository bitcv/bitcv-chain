...
///////////////////Energy///////////////////////////////
//获取需要消化的能量 1 ubcvstake * 1height/1000000
func GetConsumeEnergy(amt Dec, diff int64) Int {
	consumeEng := amt.MulInt64(diff).QuoInt64(int64(1000000)).Ceil().TruncateInt()
	consumeEng  = MaxInt(consumeEng,NewInt(int64(1)))
	return consumeEng
}
