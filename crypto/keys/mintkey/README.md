...
```bash
go test -v --bench github.com/bitcv-chain/bitcv-chain/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/bitcv-chain/bitcv-chain/crypto/keys/mintkey
...
PASS
ok  	github.com/bitcv-chain/bitcv-chain/crypto/keys/mintkey	12.093s
```
