...
import (
	...
	store "github.com/bitcv-chain/bitcv-chain/store/types"
...
func registerTestCodec(cdc *codec.Codec) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "bacchain/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "bacchain/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "bacchain/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "bacchain/baseapp/msgNoRoute", nil)
}
...
func TestSetMinGasPrices(t *testing.T) {
	minGasPrices := sdk.Coins{sdk.Coin{"nbac", sdk.NewInt( 10000000)}}
	app := newBaseApp(t.Name(), SetMinGasPrices(minGasPrices.String()))
	require.Equal(t, minGasPrices.AmountOf("nbac").ToDec(), app.minGasPrices.AmountOf("nbac"))
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "bacchain/baseapp/msgNoDecode", nil)
