...
func (app *BaseApp) initFromMainStore(baseKey *sdk.KVStoreKey) error {
	...
	// needed for `bacd export`, which inits from store but never calls initchain
...
func (app *BaseApp) cacheTxContext(ctx sdk.Context, txBytes []byte) (
	...
	ms := ctx.MultiStore()
	// TODO: https://github.com/bitcv-chain/bitcv-chain/issues/2824
...
func (app *BaseApp) runTx(mode runTxMode, txBytes []byte, tx sdk.Tx) (result sdk.Result) {
	...
	if app.anteHandler != nil {
		...
		// Ref: https://github.com/bitcv-chain/bitcv-chain/issues/2772
		//
